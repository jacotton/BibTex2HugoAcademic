...
if ($err || $help) { 
	...
	print "\n";
	print "Parses a BibTeX file and produces publication folders and index.md files for Hugo Academic theme\n";
	print "Tested on BibTeX generated by TexMed at https://www.bioinformatics.org/texmed/.\n";
}
